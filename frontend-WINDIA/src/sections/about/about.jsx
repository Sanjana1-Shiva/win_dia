...
import heroImage from "./images/hero-khakra.jpg";
...
/* ==================================================
   ...
   colored via currentColor so they inherit the palette
================================================== */
...
function IconStar(props) {
  return (
    <svg viewBox="0 0 24 24" width="26" height="26" fill="currentColor" stroke="none" {...props}>
...
function IconLeaf(props) {
  return (
    <svg viewBox="0 0 24 24" width="24" height="24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round" {...props}>
      <path d="M11 20A7 7 0 0 1 4 13c0-6 7-11 15-11 0 8-5 15-11 15-1.3 0-2-.2-3-1Z" />
      <path d="M4 20c4-2 8-6 11-11" />
    </svg>
  );
}
...
const tabs = {
  mission: {
    ...
    stats: [
      { value: "LOW CARB", sub: "MINDFUL NUTRITION", icon: "leaf" },
      { value: "HIGH FIBRE", sub: "GUT FRIENDLY", icon: "droplet" },
      { value: "GLUTEN FREE", sub: "MODERN LIFESTYLES", icon: "shield" },
      { value: "PROTEIN RICH", sub: "AUTHENTIC TASTE", icon: "heart" },
    ],
  },
...
const STATS = [
  { value: "10,000", suffix: "+", label: "Happy Customers", icon: IconUsers },
  { value: "20", suffix: "+", label: "Wholesome Products", icon: IconBox },
  { value: "4.8", suffix: "/5", label: "Average Rating", icon: IconStar },
  { value: "100", suffix: "%", label: "Gluten-Free Recipes", icon: IconLeaf },
];
...
// General scroll-reveal: fade up + slight scale for any element
// carrying the .reveal or .reveal-scale class (stats, benefits,
// founders heading, blog card, global cards, etc.)
useEffect(() => {
...
<div className="about-hero-content">
  ...
  <p className="about-hero-label">
    <span className="about-hero-label-dot" />
    ROOTED IN TRADITION
  </p>
  ...
  <div className="about-tabs-meaning-overlay">
    ...
    <p className="about-tabs-meaning-sub">
      DIAMETER · DIABETES · TO WIN
        ...
        <div className="about-tabs-txt-col">
          ...
          <p className="about-tabs-body"><em style={{color:"#F97316"}}>DIA</em> carries two meanings. The first — diabetes, the condition becoming the defining health crisis of our generation. The second — diameter. The full circle. Everywhere, all around.</p>
          <p className="about-tabs-body"><em style={{color:"#065F46"}}>WIN</em> is the intention. To beat diabetes, not in one kitchen or one city, but everywhere food is eaten and choices are made.</p>
    ...
    {/* 
    Formulation / Ingredient panels kept as reference for a future
    "science" and "coconut" tab — intentionally left out of the
    2-tab nav above so the section stays focused. Re-enable by adding
    entries to the tabs array and the conditional blocks below.
    */}
  </div>
</section>
...
<section className="about-stats">
  ...
  <div className="about-stats-heading reveal">
  <h2 className="about-stats-title">Why People Trust Us</h2>
</div>
    ...
    <div className="about-stats-grid">
      {STATS.map((s, i) => {
        ...
        return (
          <div
            key={s.label}
            className="about-stats-card reveal-scale"
          ...
          >
            ...
            <span className="about-stats-value">
              {s.value}
              <span className="about-stats-suffix">{s.suffix}</span>
            </span>
            <p className="about-stats-caption">{s.label}</p>
          </div>
        );
      })}
    </div>

    <div className="about-stats-trustline reveal">
      <IconShield width="18" height="18" />
      <span>FSSAI-registered · Lab-tested batches · Made in India</span>
    </div>
  ...
  <div className="about-mission-container reveal">
    ...
    {activeTab === "mission" && (
      ...
      <div className="about-mission-features">
        ...
        {current.stats.map((item, i) => {
          const Icon = FEATURE_ICONS[item.icon] || IconLeaf;
          return (
            <div
              key={item.value}
              className="about-mission-feature reveal"
              style={{ transitionDelay: `${i * 0.08}s` }}
            >

              <span className="about-mission-feature-icon">
                <Icon />
              </span>
...
<section className="about-founders">
  ...
  <div className="about-founders-container">
    ...
    {/* Heading */}
    <div className="about-founders-heading reveal">
...
<section className="about-blog">
  <div className="about-blog-container">
    ...
    <div className="about-blog-heading reveal">
    ...
    <div
      className="about-blog-teaser-card reveal"
...
<section className="about-global">
  <div className="about-global-container">
    <div className="about-global-heading reveal">
  ...
  <button
    ...
    className={`about-global-card ${
      selectedRegion === r.id ? "about-global-card-active" : ""
    }`}
...
function WorldMapSVG({ selected, onSelect }) {
  return (
    <div style={{
      background:  "linear-gradient(135deg, #065F46 0%, #16A34A 60%, #3FBE73 100%)",
      borderRadius: "20px",
      ...
      >
            ...
            geographies.map((geo) => {
              ...
              return (
                <Geography
                  ...
                  fill={
                    isIndia       ? "#F97316" :
                    isHighlighted ? "#FB923C" :
                                    "#F8DBBF"
                  }
                  stroke={isHighlighted || isIndia ? "#FDEADA" : "rgba(55,65,81,0.18)"}
                  strokeWidth={isHighlighted || isIndia ? 0.7 : 0.4}
                  style={{
                    default: { outline: "none", cursor: isClickable ? "pointer" : "default" },
                    hover:   { outline: "none", fill: isHighlighted ? "#EA6A0A" : isIndia ? "#F97316" : "#F0C89D" },
        ...
        <Marker coordinates={REGION_LONLAT.india}>
          ...
          <text y={-12} textAnchor="middle" style={{ fontSize:"8px", fontWeight:700, fill:"#FDEADA", letterSpacing:"0.12em", fontFamily:"sans-serif" }}>
            INDIA
          </text>
        </Marker>
      </ComposableMap>
...
function AnimatedFlightDot({ from, to, active }) {
  ...
  return (
    <Marker coordinates={coords}>
      <circle r={9} fill="#F97316" opacity={0.25} />
      <circle r={4.5} fill="#F97316" stroke="#fff" strokeWidth={1} />
    </Marker>
  );
}
